          ...
          >
            <div className="flex items-center gap-3">
              ...
              <svg 
                ...
                className="text-[#ec4899] shrink-0"
              >
                <path 
              ...
              <p className="text-sm">
                <span className="font-semibold text-[#f5f7fa]">Mumbai Office:</span>{" "}
                <span className="text-[#8b93a3]">Based in Mumbai, India. Serving clients worldwide.</span>
              </p>
            </div>
